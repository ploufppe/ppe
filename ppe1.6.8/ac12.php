			...
			<div id="wrapper">
										...
										<center><h2>ETAPES</h2></center>
											<hr>
												<?php
													...
													echo "$LIEUNOM";
													echo '</td>';
													echo '<td><a href="delete/delete_ac12.php?id='.$ETPID.'"><img src="images/delete-cross.png" /></a></td><td><a href="ac43.php?id='.$ETPID.'&TRNNUM='.$TRNNUM.'"><img src="images/crayon.png" /></a></td></tr>';
													}
													echo '</table>';
												?>
												<?php
				...
				<!-- Sidebar -->
					<section id="sidebar">
						...
						<article class="post" >
							<section class="blurb" >
								<center><h1>TOURNEE N&#186; <?php echo $TRNNUM; ?></h1></center>
									<hr>
