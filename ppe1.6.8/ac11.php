				...
				<!-- Main -->
					...
					<!-- Post -->
							<article class="post">
								...
								<div class="meta">
									<section>
										<center><h2>Tourn&eacute;es</h2></center>
											<hr>
												<?php
													...
													<th>Immatriculation v&eacute;hicule</th>
													<th>Chauffeur</th>
													<th>Date tourn&eacute;e</th>
													<th>Prise en charge par le chauffeur</th>
													<th>Arriv&eacute;e du chauffeur</th>
													<th>Commentaire(s) tourn&eacute;e</th>
													<th></th>
													<th></th>
													</tr>';
													...
													// Début de réfléxion sur l'affichage du départ et des arrivées
													/*$sql2 = "select ETPID from etape WHERE TRNNUM = ".$TRNID." ORDER BY ETPID";
														$result2 = tableSQL($sql2);
														$result2Bis = compteSQL($sql2);
													echo '</td><td>';
														$depart=$result2['0']['0'];
													echo $depart;
													echo '</td>';
													echo '</td><td>';
														$arrivee=$result2[$result2Bis]['0'];
													echo $arrivee;
													echo '</td>';
													*/
