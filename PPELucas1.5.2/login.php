						...
						<!-- Post -->
							<article class="post">
								...
								<h4>Identifiez vous :</h4>
												<label for="PalLiv">Votre Identifiant :</label>
													<input type="login" name="logId" id="logID" size="10" value="login" />
													<br />
												<label for="PalLivEur">Mot de Passe:</label>
													<input type="password" name="logMP" id="logMP" size="10" value="password" />
													<br />
													<hr>
