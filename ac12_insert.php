										...
										<div class="row uniform">
											<div class="6u 12u$(xsmall)">
												...
												<!-- Affichage des vehicules -->
													...
													<input type="datetime-local" name="calendrier" id="calendrier" value="yyyy/mm/dd" style="border: solid 1px #2ecc71;" />
													</div>
												</div>
													<!-- affichage de la zone de commentaire -->
												<br />
												<label for="commentaire">Commentaire : <br /></label>
													<textarea name="ac12commentaire">Tapez votre texte!</textarea>	
											</div>
											<br />
											<div class="12u$">
												<ul class="actions">
