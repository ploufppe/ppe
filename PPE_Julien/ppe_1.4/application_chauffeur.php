								...
								<section>
										...
										<div class="row uniform">
											<div class="6u 12u$(xsmall)">
												...
												<div class="select-wrapper">
													...
													<label for="calendrier">Le : </label>
													<input type="date" name="calendrier" id="calendrier" value="date" />
									...
									<h4>Palette(s):</h4>
												<label for="PalLiv">Livrée:</label>
													<input type="text" name="PalLiv" id="PalLiv" size="10"/>
													<br />
												<label for="PalLivEur">dont EUR:</label>
													<input type="text" name="PalLivEur" id="PalLivEur" size="10"/>
													<br />
													<hr>
												<label for="PalChg">Chargée:</label>
													<input type="text" name="PalChg" id="PalChg" size="10"/>
													<br />
												<label for="PalChgEur">dont EUR:</label>
													<input type="text" name="PalChgEur" id="PalChgEur" size="10"/>
													<br />
									    	<hr>
									    			<h4>Prendre une photo:</h4>
													<input type="file" name="photo" id="photo" value="Prendre une photo"/>
													<br />
											<hr>
